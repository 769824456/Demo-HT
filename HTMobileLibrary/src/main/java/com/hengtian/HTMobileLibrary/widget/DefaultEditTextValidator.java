package com.hengtian.HTMobileLibrary.widget;
...
import com.hengtian.HTMobileLibrary.formEdittextValidator.AlphabeticAndNumericValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.AlphabeticValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.AndValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.CreditCardValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.DateValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.DomainValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.DummyValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.EmailValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.EmptyValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.IpAddressValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.MultiValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.NotValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.NumericRangeValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.NumericValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.OrValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.PersonFullNameValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.PersonNameValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.PhoneValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.RegexpValidator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.Validator;
import com.hengtian.HTMobileLibrary.formEdittextValidator.WebUrlValidator;
...
public class DefaultEditTextValidator
    ...
    public void resetValidators(Context context) {
        ...
        switch (testType) {
            ...
            case TEST_ALPHA:
                toAdd =
                        new AlphabeticValidator(TextUtils.isEmpty(testErrorString) ? context.getString(R.string.error_only_standard_letters_are_allowed)
                                : testErrorString);
                break;
            case TEST_ALPHANUMERIC:
                toAdd =
                        new AlphabeticAndNumericValidator(
