...
public class FormAutoCompleteTextView extends AutoCompleteTextView {
     ...
     */
    public void addValidator(com.hengtian.HTMobileLibrary.formEdittextValidator.Validator theValidator) throws IllegalArgumentException {
     ...
     * customValidators and call {@link com.hengtian.HTMobileLibrary.formEdittextValidator.Validator#isValid(EditText)}
     *
     * @return true if the validity passes false otherwise.
     */
    public boolean testValidity() {
        return editTextValidator.isValidity();
    }
