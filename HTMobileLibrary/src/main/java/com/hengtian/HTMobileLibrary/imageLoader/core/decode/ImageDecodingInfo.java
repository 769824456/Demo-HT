 ...
 *******************************************************************************/
package com.hengtian.HTMobileLibrary.imageLoader.core.decode;

import android.annotation.TargetApi;
import android.graphics.BitmapFactory.Options;
import android.os.Build;

import com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.hengtian.HTMobileLibrary.imageLoader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
