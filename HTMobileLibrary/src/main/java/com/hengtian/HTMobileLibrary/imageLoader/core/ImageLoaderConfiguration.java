 ...
 *******************************************************************************/
package com.hengtian.HTMobileLibrary.imageLoader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.hengtian.HTMobileLibrary.imageLoader.cache.disc.DiskCache;
import com.hengtian.HTMobileLibrary.imageLoader.cache.disc.naming.FileNameGenerator;
import com.hengtian.HTMobileLibrary.imageLoader.cache.memory.MemoryCache;
import com.hengtian.HTMobileLibrary.imageLoader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.hengtian.HTMobileLibrary.imageLoader.core.assist.FlushedInputStream;
import com.hengtian.HTMobileLibrary.imageLoader.core.assist.ImageSize;
import com.hengtian.HTMobileLibrary.imageLoader.core.assist.QueueProcessingType;
import com.hengtian.HTMobileLibrary.imageLoader.core.decode.ImageDecoder;
import com.hengtian.HTMobileLibrary.imageLoader.core.download.ImageDownloader;
import com.hengtian.HTMobileLibrary.imageLoader.core.process.BitmapProcessor;
import com.hengtian.HTMobileLibrary.imageLoader.utils.L;
import com.hengtian.HTMobileLibrary.imageLoader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.hengtian.HTMobileLibrary.imageLoader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		 ...
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.hengtian.HTMobileLibrary.imageLoader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.hengtian.HTMobileLibrary.imageLoader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.hengtian.HTMobileLibrary.imageLoader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.hengtian.HTMobileLibrary.imageLoader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.hengtian.HTMobileLibrary.imageLoader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.hengtian.HTMobileLibrary.imageLoader.utils.L#disableLogging()} to disable
