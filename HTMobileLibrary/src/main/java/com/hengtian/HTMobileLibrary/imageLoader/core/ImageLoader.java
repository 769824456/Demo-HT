...
import com.hengtian.HTMobileLibrary.imageLoader.core.assist.FailReason;
...
import com.hengtian.HTMobileLibrary.imageLoader.core.assist.ViewScaleType;
import com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageAware;
import com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageViewAware;
import com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.NonViewAware;
import com.hengtian.HTMobileLibrary.imageLoader.core.listener.ImageLoadingListener;
import com.hengtian.HTMobileLibrary.imageLoader.core.listener.ImageLoadingProgressListener;
import com.hengtian.HTMobileLibrary.imageLoader.core.listener.SimpleImageLoadingListener;
import com.hengtian.HTMobileLibrary.imageLoader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions Options} for image
	 ...
	 *                         {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
