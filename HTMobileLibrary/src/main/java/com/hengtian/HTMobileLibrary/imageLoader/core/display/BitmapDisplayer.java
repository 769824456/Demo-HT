...
/**
 * Displays {@link Bitmap} in {@link com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageAware}. Implementations can
 * apply some changes to Bitmap or any animation for displaying Bitmap.<br />
 * Implementations have to be thread-safe.
 *
 * @see com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageAware
 * @see LoadedFrom
 * @since 1.5.6
 */
public interface BitmapDisplayer {
	/**
	 * Displays bitmap in {@link com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageAware}.
	 * <b>NOTE:</b> This method is called on UI thread so it's strongly recommended not to do any heavy work in it.
	 *
	 * @param bitmap     Source bitmap
	 * @param imageAware {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.imageaware.ImageAware Image aware view} to
	 *                   display Bitmap
