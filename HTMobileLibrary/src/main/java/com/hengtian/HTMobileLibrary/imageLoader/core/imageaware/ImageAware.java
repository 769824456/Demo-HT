 ...
 *******************************************************************************/
package com.hengtian.HTMobileLibrary.imageLoader.core.imageaware;
 ...
 * through {@link com.hengtian.HTMobileLibrary.imageLoader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.hengtian.HTMobileLibrary.imageLoader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
 * @see ViewAware
 * @see ImageViewAware
...
public interface ImageAware {
	 ...
	 * {@link com.hengtian.HTMobileLibrary.imageLoader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.hengtian.HTMobileLibrary.imageLoader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.hengtian.HTMobileLibrary.imageLoader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.hengtian.HTMobileLibrary.imageLoader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
